...
function buildContaminationTable(doc, templateTable, contaminationRows) {
  ...
  trs.push(
    makeRow([
      ...
      makeCell(headerTc, { text: "최고농도(mg/kg)", colAddr: 6, rowAddr, rowSpan: 2, width: colW(6), height: CONTAM_ROW_H * 2 }),
      makeCell(headerTc, { text: "오염면적(m²)", colAddr: 7, rowAddr, rowSpan: 2, width: colW(7), height: CONTAM_ROW_H * 2 }),
      makeCell(headerTc, { text: "오염량(m³)", colAddr: 8, rowAddr, rowSpan: 2, width: colW(8), height: CONTAM_ROW_H * 2 }),
    ])
  );
  rowAddr++;
  trs.push(
